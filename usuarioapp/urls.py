...
from django.contrib.auth.views import *
    # import password_change, password_change_done, password_reset, password_reset_done, \
...
urlpatterns = [
    ...
    # ---- Senha ----#
    url(r'^usuario/alterar-senha/$', PasswordChangeView.as_view(template_name= 'usuarioapp/alterarsenha-form.html'), { 'template_name': 'usuarioapp/alterarsenha-form.html'}, name='password_change'),
    url(r'^usuario/alterar-senha/feito/$', PasswordChangeDoneView.as_view(template_name= 'usuarioapp/alterarsenha-feito.html'), {'template_name': 'usuarioapp/alterarsenha-feito.html'}, name='password_change_done'),

    url(r'^usuario/redefinir-senha/$', PasswordResetView.as_view(template_name = 'usuarioapp/redefinirsenha-form.html',
                                                          email_template_name= 'usuarioapp/redefinirsenha-email.html',
                                                          subject_template_name= 'usuarioapp/redefinirsenha-assunto.txt'), {'template_name': 'usuarioapp/redefinirsenha-form.html','email_template_name' : 'usuarioapp/redefinirsenha-email.html',
                                                          'subject_template_name': 'usuarioapp/redefinirsenha-assunto.txt'}, name='password_reset'),
    url(r'^usuario/redefinir-senha/feito/$', PasswordResetDoneView.as_view(template_name ='usuarioapp/redefinirsenha-feito.html'), {'template_name': 'usuarioapp/redefinirsenha-feito.html'}, name='password_reset_done'),
    url(r'^usuario/redefinir/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$', PasswordResetConfirmView.as_view(template_name ='usuarioapp/redefinirsenha-confirmacao.html'), {'template_name': 'usuarioapp/redefinirsenha-confirmacao.html'}, name='password_reset_confirm'),
    url(r'^usuario/redefinir/feito/$', PasswordResetCompleteView.as_view(template_name ='usuarioapp/redefinirsenha-completo.html'), {'template_name': 'usuarioapp/redefinirsenha-completo.html'}, name='password_reset_complete'),
