...
from usuarioapp.forms.user import *
from sgaapapp.variaveis import DETAIL_COMPLEMENTO_USUARIO, LIST_USER, DETAIL_USER, DELETE_USER
from sgaapapp.views.email import send_mail
...
class UserConvidadoAjaxCreateView(View):
    ...
    def post(self, request):
        ...
        if  form.is_valid():
            ...
            data['campo_alterar'] = 'id_servidor'
            data['sucesso'] = True
